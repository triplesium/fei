...
class VectorContainerAdapter final : public ContainerAdapter {
  public:
...
class ArrayContainerAdapter final : public ContainerAdapter {
  public:
    ContainerKind kind() const override { return ContainerKind::Sequence; }
...
class OptionalContainerAdapter final : public ContainerAdapter {
  public:
