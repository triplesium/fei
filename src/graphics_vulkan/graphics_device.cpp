...
GraphicsDeviceVulkan::create_buffer(const BufferDescription&) const {
    vulkan_not_implemented("create_buffer");
}

std::shared_ptr<Texture>
GraphicsDeviceVulkan::create_texture(const TextureDescription&) const {
    vulkan_not_implemented("create_texture");
}

std::shared_ptr<TextureView>
GraphicsDeviceVulkan::create_texture_view(const TextureViewDescription&) const {
...
GraphicsDeviceVulkan::create_framebuffer(const FramebufferDescription&) const {
...
GraphicsDeviceVulkan::create_sampler(const SamplerDescription&) const {
...
MappedResource
GraphicsDeviceVulkan::map(std::shared_ptr<MappableResource>, MapMode) const {
    vulkan_not_implemented("map");
}

void GraphicsDeviceVulkan::unmap(std::shared_ptr<MappableResource>) const {
...
void GraphicsDeviceVulkan::present(const Swapchain&) const {
    vulkan_not_implemented("present");
}
