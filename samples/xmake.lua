function add_sample(name, source)
    target("sample-" .. name)
        ...
        add_deps("fei-refl", "fei-ecs", "fei-app", "fei-window-glfw", "fei-input", "fei-core", "fei-asset", "fei-graphics-opengl", "fei-graphics-opengl-glfw", "fei-graphics", "fei-rendering", "fei-imgui", "fei-pbr", "fei-scene", "fei-scripting-lua")
