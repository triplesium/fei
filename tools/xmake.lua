local function parse_target(project, target)
    local headers = {}
    local include_dirs = {}
    for _, dep in pairs(target:get("deps")) do
...
task("reflgen")
    on_run(function ()
        ...
        local headers = {}
        local include_dirs = {}
        parse_target(project, project.target("fei-generated"))
        ...
        args = {"tools/reflgen.py", "--rootdir", "src", "-t", "tools/reflgen.jinja", "--output", "src/generated/reflgen.cpp"}
