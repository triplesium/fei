...
TEST_CASE(
    ...
    REQUIRE(decl->types[0].fields[0].type.type_name == "i32");
    REQUIRE_FALSE(decl->types[0].fields[0].type.type_id);
    ...
    REQUIRE(decl->types[0].fields[1].type.type_name == "i32");
    REQUIRE_FALSE(decl->types[0].fields[1].type.type_id);
