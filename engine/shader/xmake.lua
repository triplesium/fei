...
local function add_slang(target, public)
    if is_plat("wasm") then
        target:add("packages", "entisium-slang-wasm", {public = public})
...
target("entisium-shader")
    set_kind("static")
    add_headerfiles("include/**.hpp")
    add_files("src/*.cpp")
    add_includedirs("include", {public = true})
    add_deps("entisium-base", "entisium-asset", "entisium-graphics")
...
target("entisium-shader-opengl")
    ...
    add_deps("entisium-shader", "entisium-app")
...
target("entisium-shader-tests")
    set_kind("binary")
    set_default(false)
    add_rules("entisium.test")
    add_files("tests/*.cpp")
    add_deps("entisium-shader", "entisium-shader-opengl")
    on_load(function(target)
